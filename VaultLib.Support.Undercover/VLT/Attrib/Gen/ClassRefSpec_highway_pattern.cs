...
public class ClassRefSpec_highway_pattern : ClassRefSpec_template<VaultLib.Core.DataInterfaces.Key32>
{
    public ClassRefSpec_highway_pattern() : base("highway_pattern")
    {
    }
}
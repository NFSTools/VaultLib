...
namespace VaultLib.Support.Undercover.VLT.VinylsAttrib
{
    ...
    {
        public VinylLayer(VltClass @class, VltClassField field, VltCollection collection) : base(@class, field, collection)
        {
        }

        public VinylLayer(VltClass @class, VltClassField field) : base(@class, field)
        {
        }

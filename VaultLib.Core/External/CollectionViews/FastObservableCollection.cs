...
namespace VaultLib.Core.External.CollectionViews
{
    ...
    public class FastObservableCollection<T> : ObservableCollection<T>
    {
        ...
        /// </summary> 
        ///<param name="notificationMode">Accepted notificationModes are: 'NotifyCollectionChangedAction.Add' and 'NotifyCollectionChangedAction.Reset'</param>
        ...
        public void InsertRange(int index, IEnumerable<T> collection)
        {
            ...
            {
                Items.Insert(index, changedItems[i]);
            }
        ...
        /// <param name="notificationMode">By diffault this method notifies handlers of the 'CollectionChanged' event of removed items without specifiying any index. 
        /// If handlers expect the 'OldStartingIndex' property of event args being set, then NotifyCollectionChangedAction.Reset should be used.</param>
        ...
        public void RemoveRangeAt(int index, int count)
        {
            ...
            if (Items.Count - index < count)
                throw new InvalidOperationException("The given count is greater than the available items in the ObservableCollection(Of T) starting from the specified index");
            CheckReentrancy();
            List<T> removedItems = new List<T>();
        ...
        /// <summary>
        /// This method removes the given generic list of items from ObservableCollection(Of T) and dispose them if they are IDisposable and contained in the collection.
        /// </summary>
